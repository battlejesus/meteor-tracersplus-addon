package com.tracersplus.addon.modules;
...
public class TracersPlus extends Module {
    ...
    // Show only friends
    public final Setting<Boolean> justFriends = sgGeneral.add(new BoolSetting.Builder()
        .name("just-friends")
        .description("When enabled, only friends will be shown by tracers.")
        .defaultValue(false)
        .build()
    );
    ...
    // Friend toggle + color
    /*public final Setting<Boolean> friends = sgColors.add(new BoolSetting.Builder()
        .name("friends")
        .description("Show friends using the friend color.")
        .defaultValue(true)
        .build()
    );
    */
    ...
    private final Setting<SettingColor> friendColor = sgColors.add(new ColorSetting.Builder()
        .name("friend-color")
        .description("The color to use for friends.")
